...
export const LanguageOutlined = (props: SVGProps<SVGSVGElement>) => (
  <svg
...
export const CircleOutlined = (props: SVGProps<SVGSVGElement>) => (
...
export const PanelCloseOutlined = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
